...
function callback4() 
{
  ...
  x1 = document.getElementById("knopka").value 

  x1 = Number(x1)
  masivBukv = [];
  console.log(document.getElementById("knopka").value)
  document.getElementById("knopka").value = masivBukv.join("");
...
console.log(masivBukv,x1 )
  let value = document.getElementById("knopka").value
  if(deist =="-"){
    masivBukv = String(x1 - Number(value)).split("");
    document.getElementById("knopka").value = masivBukv.join("");
...
document.getElementById("knopka").oninput = function() {
